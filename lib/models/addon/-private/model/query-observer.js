...
//   destroyModel(model) {}
// }
export default class QueryObserver extends Destroyable {
  ...
  _start() {
    ...
    this._cancel = this._query.onSnapshot({ includeQueryMetadataChanges: true }, snapshot => run(() => this._onSnapshot(snapshot)));
  }
