...
export default EmberObject.extend({
  ...
  _loadInternalDocument(opts) {
    let internal = this._existingInternalDocument(opts, true);
    return internal.load();
  },

  loadDocument(opts) {
    return this._loadInternalDocument(opts).then(internal => internal.model(true));
  }
